...
public class AjaxResult extends HashMap<String,Object> {
    ...
    public static AjaxResult adminSuccess(Object data) {
        return new AjaxResult(HttpStatus.ADMIN_SUCCESS,"操作成功", data);
    }
    ...
    public static AjaxResult toAjax(int rows,String msg,String errorMsg) {
        return rows > 0 ? AjaxResult.success(msg) : AjaxResult.fail(errorMsg);
    }
}
